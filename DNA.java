...
public class DNA {
    ...
    public void createDatabaseOfProfiles ( String filename ) {
        ...
        database = new Profile[x];
        for(int i = 0; i < x; i++){
            String n = StdIn.readLine();
            String s1 = StdIn.readLine();
            String s2= StdIn.readLine();
            Profile prof = new Profile(n, null, null, s1, s2);
            database[i] = prof; 
        }
    }
    ...
    public void readSTRsOfInterest ( String filename ) {
        ...
        int str = Integer.parseInt(StdIn.readLine());
        STRsOfInterest = new String[str];
        for(int i = 0; i < str; i++){
    ...
    String sequ1 = StdIn.readString();
    String sequ2 = StdIn.readString();
    Profile Un = new Profile("Unknown", null, null, sequ1, sequ2);
    return Un;
    }
    ...
    public STR findSTRInSequence ( String sequence, String STR ) {
        ...
        STR in = new STR(STR, longn);
        return in; // update the return value
    }
    ...
    public ArrayList<Profile> findMatchingProfiles ( STR[] unknownProfileS1_STRs ) {
        ...
        ArrayList<Profile> yes = new ArrayList<Profile>();
        for(int i = 0; i < database.length; i++){
            Profile np = database[i];
            if(identicalSTRs(np.getS1_STRs(), unknownProfileS1_STRs) == true){
                yes.add(np);
            }
        }
	return yes;
